...
static_uncertainty = cbind( c(len_static - (len_na_e1+len_0_e1), len_na_e1, len_0_e1),
                            c(len_static - (len_na_e2+len_0_e2), len_na_e2, len_0_e2),
                            c(len_static - (len_na_e3+len_0_e3), len_na_e3, len_0_e3),
                            c(len_static - (len_na_e4+len_0_e4), len_na_e4, len_0_e4),
                            c(len_static - (len_na_e5+len_0_e5), len_na_e5, len_0_e5),
                            c(len_static - (len_na_e6+len_0_e6), len_na_e6, len_0_e6),
                            c(len_static - (len_na_e7+len_0_e7), len_na_e7, len_0_e7),
                            c(len_static - (len_na_e8+len_0_e8), len_na_e8, len_0_e8),
                            c(len_static - (len_na_e9+len_0_e9), len_na_e9, len_0_e9) )
